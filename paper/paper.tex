...
The synthetic evaluation uses four workload profiles designed to isolate the primary metrics: burst arrivals stress makespan, energy-constrained arrivals stress efficiency, radiation-annotated arrivals stress resilience, and mixed-priority arrivals stress scheduling differentiation. Quantitative results and statistical comparisons will be added after the batch experiments are completed; this section currently documents the experimental design rather than numerical findings.
